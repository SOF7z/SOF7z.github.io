                        ...
                        $no=1;
                         foreach($guru as $gr ) : ?>
                          <tr>
                            ...
                            <td><h6><?php echo $gr->id_guru ?></h6></td>
                            <td><h6><?php echo $gr->nama ?></h6></td>
                            <td><h6><?php echo $gr->alamat ?></h6></td> 
                            <td><h6><?php echo $gr->kelas ?></h6></td>
                            <td><h6><?php echo $gr->gender ?></h6></td>
                            <td><h6><?php echo $gr->no_hp ?></h6></td>
                            <td><h5><?php 
                                            if ($gr->status <= "0"){
